...
@Setter
@Entity
@Table(name = "ban_ve_ve")
public class BanVeVeEntity implements Serializable {
    ...
    @Column(name = "bvv_bex_id_a")
    private Integer bvvBexIdA;

    @Column(name = "bvv_bex_id_b")
    private Integer bvvBexIdB;
    ...
    @Column(name = "bvv_fast", columnDefinition = "TINYINT")
    private Boolean bvvFast;

    @Column(name = "bvv_ben_trung_chuyen_a")
    private Integer bvvBenTrungChuyenA;

    @Column(name = "bvv_ben_trung_chuyen_b")
    private Integer bvvBenTrungChuyenB;
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.JSON_STYLE)
                ...
                .append("bvvBexIdA", bvvBexIdA)
                .append("bvvBexIdB", bvvBexIdB)
                ...
                .append("bvvFast", bvvFast)
                .append("bvvBenTrungChuyenA", bvvBenTrungChuyenA)
                .append("bvvBenTrungChuyenB", bvvBenTrungChuyenB)
                .toString();
    }
}
